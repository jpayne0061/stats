...
crime_data = pd.read_csv("/home/ubuntu/workspace/crime_stat2.csv") 
...
plt.yticks(range(0, 22, 2), [str(x) + "%" for x in range(0, 22, 2)], fontsize=14)    
...
plt.text(2008, 22, "Percentage of Crime Incidents in Louisville, KY"    
       ", by crime (2003-2015)", fontsize=17, ha="center")    
...
plt.text(2003, -3, "Data source: http://portal.louisvilleky.gov/dataset/crimedataall-data"    
...
plt.savefig("crime.png", bbox_inches="tight")  
